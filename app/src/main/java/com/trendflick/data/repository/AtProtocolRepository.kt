...
interface AtProtocolRepository {
    ...
    suspend fun getTimeline(algorithm: String, limit: Int, cursor: String? = null): Result<TimelineResponse>
    suspend fun getPostThread(uri: String): Result<ThreadResponse>
    suspend fun getPostsByHashtag(hashtag: String, limit: Int, cursor: String? = null): Result<TimelineResponse>
